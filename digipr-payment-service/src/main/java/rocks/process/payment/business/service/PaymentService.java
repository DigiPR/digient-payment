...
package rocks.process.payment.business.service;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import rocks.process.payment.api.model.Discount;
import rocks.process.payment.business.client.CustomerServiceClient;
import rocks.process.payment.business.client.PaymentServiceProviderClient;
...
import rocks.process.payment.data.repository.TransactionRepository;
...
public class PaymentService {
    ...
    @Autowired private CustomerServiceClient customerService;
    @Autowired private PaymentServiceProviderClient psp;
    ...
    public Transaction processPayment(Long customerId, String reference, Amount amount, Integer numberOfItems) throws Exception {
        ...
        Transaction transaction = new Transaction(customer, reference, amount);
        ...
        Amount remainingAmount = deductLoyaltyPoints(customer, amount);
